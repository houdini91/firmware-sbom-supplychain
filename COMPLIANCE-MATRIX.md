...
| **Total** | **38** | **37 gated + 1 advisory** | **37/38** | §4.3.1 Detection is the one advisory-MISSING, honest on clean |

37/38 satisfied on a clean release. The one non-green control (§4.3.1 Detection) is
