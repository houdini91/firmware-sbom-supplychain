...
> clean demo (no device), but when PRESENT it **gates** (a confirmed on-device byte swap / missing / unexpected
> module DENYs, byte-integrity-like); and the three CHIPSEC posture reports
