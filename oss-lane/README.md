...
| [`fixtures/`](fixtures) | 26 gate-input **test vectors**: `clean.json` (ALLOW), `accepted-cve.json` (triaged ALLOW), and 24 negative fixtures each isolating a report's failure mode. Driven by [`../tests/run.sh`](../tests/run.sh). |
