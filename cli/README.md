...
the last `DEV_ASSUME` on the consumer path); byte-integrity is done (R4) — the producer already matches shipped PE32 bytes to the SBOM via un-rebase canonicalization (122 of 123 modules).
